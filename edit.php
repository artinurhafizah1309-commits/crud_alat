...
// Cek apakah form sudah disubmit untuk update, lalu alihkan ke index setelah berhasil
...
// Mengambil ID dari URL untuk menampilkan data yang akan diedit
$id = $_GET['id'];
...
<body>
    ...
    <div class="container">
        ...
        <div class="header-title">
            ...
            <h2>Edit Data Alat Elektromedis</h2>
        </div>
        ...
        <form action="edit.php" method="post" name="update_alat">
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="nama_alat" id="nama_alat" class="form-control" value="<?php echo $nama_alat;?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="number" name="tahun" id="tahun" class="form-control" value="<?php echo $tahun;?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="merek" id="merek" class="form-control" value="<?php echo $merek;?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="lokasi" id="lokasi" class="form-control" value="<?php echo $lokasi;?>" required>
                </div>
            </div>

            <!-- Hidden input untuk ID agar data ter-update dengan benar -->
            <input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
            
            <button type="submit" name="update" class="btn-submit">
                <i class="fa-solid fa-floppy-disk"></i> Perbarui Data Alat
            </button>
        </form>
    </div>
